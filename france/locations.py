...
def boulogne_billancourt():
    return _french_location("Boulogne-Billancourt")

def boulogne_sur_mer():
...
def chalon_sur_saone():
    return _french_location("Chalon-sur-Saône")

def chalons_sur_marne():
...
def la_guerche_de_bretagne():
    return _french_location("La Guerche-de-Bretagne")

def la_haie_fouassiere():
...
def le_monetier_les_bains():
    return _french_location("Le Monetier-les-Bains")

def le_perreux_sur_marne():
...
def maubourguet_pays_du_val_d_adour():
...
def morcenx():
    return _french_location("Morcenx")
...
def neufchatel_en_bray():
    return _french_location("Neufchatel-en-Bray")

def neuville_de_poitou():
...
# S
def sable_sur_sarthe():
    return _french_location("Sablé-sur-Sarthe")

def saint_amand_les_eaux():
    return _french_location("Saint-Amand-les-Eaux")

def saint_amand_montrond():
    return _french_location("Saint-Amand-Montrond")

def saint_arnoult_en_yvelines():
    return _french_location("Saint-Arnoult-en-Yvelines")
