...
def auronzo_di_cadore():
    return _italian_location("Auronzo di Cadore")

def autodromo_enzo_e_dino_ferrari():
...
def borgo_san_dalmazzo():
    return _italian_location("Borgo San Dalmazzo")

def borgo_val_di_taro():
    return _italian_location("Borgo Val di Taro")
...
def campione_d_italia():
    return _italian_location("Campione d'Italia")

def campitello_matese():
...
def castigilione_della_pescaia():
    return _italian_location("Castiglione della Pescaia")

def castiglione_del_lago():
    return _italian_location("Castiglione del Lago")

def castiglione_della_pescaia():
    return _italian_location("Castiglione della Pescaia")

def castrocaro_terme():
...
def chianti_classico_stage():
    return _italian_location("Chianti Classico Stage")
...
def colli_di_san_fermo():
    return _italian_location("Colli di San Fermo")

def collina_di_superga():
...
def courmayeur_skyway_monte_bianco():
    return _italian_location("Courmayeur (Skyway Monte Bianco)")
...
def darfo_boario_terme():
    return _italian_location("Darfo Boario Terme")

def desenzano_del_garda():
...
def gradisca_d_isonzo():
    return _italian_location("Gradisca d'Isonzo")

def grado():
    return _italian_location("Grado")

def gran_sasso_d_italia():
    return _italian_location("Gran Sasso d'Italia")

def gran_sasso_d_italia_campo_imperatore():
    return _italian_location("Gran Sasso d'Italia (Campo Imperatore)")

def gravellona_toce():
    return _italian_location("Gravellona Toce")

def gressoney_saint_jean():
...
def imola_autodromo_enzo_e_dino_ferrari():
    return _italian_location("Imola (Autodromo Enzo e Dino Ferrari)")
...
def mendrisio():
    return _italian_location("Mendrisio")
...
def montecatini_terme():
    return _italian_location("Montecatini Terme")

def montecchio_maggiore():
...
def ortisei_st_ulrich_val_gardena():
    return _italian_location("Ortisei/St. Ulrich (Val Gardena)")
...
def passo_del_tonale():
    return _italian_location("Passo del Tonale")

def passo_di_pampeagno():
...
def poggio_di_san_remo():
    return _italian_location("Poggio di San Remo")

def policastro_bussentino():
...
def porto_san_giorgio():
    return _italian_location("Porto San Giorgio")

def porto_sant_elpidio():
...
def roccaraso_aremogna():
    return _italian_location("Roccaraso (Aremogna)")
