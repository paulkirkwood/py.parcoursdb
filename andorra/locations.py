from country import Andorra
from location import Location

def andorra_la_vella():
    return Location("Andorra la Vella", Andorra())

def envalira():
    return Location("Envalira", Andorra())
...
def escaldes_engordany():
    return Location("Escaldes-Engordany", Andorra())
