...
class TestGiro:
    ...
    def test_giro1909(self):
        route="""1,13 May,Milan to Bologna,397.0 km,Road stage
        ...
        8,30 May,Turin to Milan,206.0 km,Road stage"""

        edition = giro.giro1909()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "8 stages"

    def test_giro1910(self):
        route="""1,18 May,Milan to Udine,388.0 km,Road stage
        ...
        10,5 June,Turin to Milan,277.5 km,Road stage"""

        edition = giro.giro1910()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "10 stages"

    def test_giro1911(self):
        route="""1,15 May,Rome to Florence,394.1 km,Road stage
        ...
        edition = giro.giro1911()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "12 stages"

    def test_giro1912(self):
        route="""1,19 May,Milan to Padua,398.8 km,Road stage
        ...
        8,2 June,Turin to Milan,280.0 km,Road stage
        9,4 June,Milan to Bergamo,235.0 km,Road stage"""

        edition = giro.giro1912()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "9 stages"

    def test_giro1913(self):
        route="""1,6 May,Milan to Genoa,341.0 km,Road stage
        ...
        9,22 May,Rovigo to Milan,321.5 km,Road stage"""

        edition = giro.giro1913()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "9 stages"

    def test_giro1914(self):
        route="""1,24 May,Milan to Cuneo,420.0 km,Road stage
        ...
        8,7 June,Lugo to Milan,420.3 km,Road stage"""

        edition = giro.giro1914()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "8 stages"

    def test_giro1919(self):
        route="""1,21 May,Milan to Trento,302.8 km,Road stage
        ...
        10,8 June,Turin to Milan,277.0 km,Road stage"""

        edition = giro.giro1919()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "10 stages"

    def test_giro1920(self):
        route="""1,23 May,Milan to Turin,348.0 km,Road stage
        ...
        8,6 June,Trieste to Milan,421.0 km,Road stage"""

        edition = giro.giro1920()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "8 stages"

    def test_giro1921(self):
        route="""1,25 May,Milan to Merano,333.0 km,Road stage
        ...
        10,12 June,Turin to Milan,305.0 km,Road stage"""

        edition = giro.giro1921()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "10 stages"

    def test_giro1922(self):
        route="""1,24 May,Milan to Padua,326.0 km,Road stage
        ...
        10,11 June,Turin to Milan,348.0 km,Road stage"""

        edition = giro.giro1922()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "10 stages"

    def test_giro1923(self):
        route="""1,23 May,Milan to Turin,328.0 km,Road stage
        ...
        10,10 June,Mantua to Milan,341.3 km,Road stage"""

        edition = giro.giro1923()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "10 stages"

    def test_giro1924(self):
        route="""1,10 May,Milan to Genoa,300.3 km,Road stage
        ...
        12,1 June,Verona to Milan,313.0 km,Road stage"""

        edition = giro.giro1924()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "12 stages"

    def test_giro1925(self):
        route="""1,16 May,Milan to Turin,278.1 km,Road stage
        ...
        12,7 June,Verona to Milan,307.9 km,Road stage"""

        edition = giro.giro1925()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "12 stages"

    def test_giro1926(self):
        route="""1,15 May,Milan to Turin,275.0 km,Road stage
        ...
        12,6 June,Verona to Milan,288.0 km,Road stage"""

        edition = giro.giro1926()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "12 stages"

    def test_giro1927(self):
        route="""1,15 May,Milan to Turin,288.0 km,Road stage
        ...
        15,6 June,Verona to Milan,291.5 km,Road stage"""

        edition = giro.giro1927()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "15 stages"

    def test_giro1928(self):
        route="""1,12 May,Milan to Trento,233.1 km,Road stage
        ...
        12,3 June,Turin to Milan,251.0 km,Road stage"""

        edition = giro.giro1928()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "12 stages"

    def test_giro1929(self):
        route="""1,19 May,Rome to Naples,235.0 km,Road stage
        ...
        edition = giro.giro1929()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "14 stages"

    def test_giro1930(self):
        route="""1,17 May,Messina to Catania,174.0 km,Road stage
        ...
        edition = giro.giro1930()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "15 stages"

    def test_giro1931(self):
        route="""1,10 May,Milan to Mantua,206.0 km,Road stage
        ...
        12,31 May,Turin to Milan,263.0 km,Road stage"""

        edition = giro.giro1931()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "12 stages"

    def test_giro1932(self):
        route="""1,14 May,Milan to Vicenza,207.0 km,Road stage
        ...
        13,5 June,Turin to Milan,271.0 km,Road stage"""

        edition = giro.giro1932()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "13 stages"

    def test_giro1933(self):
        route="""1,6 May,Milan to Turin,169.0 km,Road stage
        ...
        ,27 May,Rest day
        17,28 May,Bolzano to Milan,284.0 km,Road stage"""

        edition = giro.giro1933()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "17 stages"

    def test_giro1934(self):
        route="""1,19 May,Milan to Turin,169.2 km,Road stage
        ...
        ,9 June,Rest day
        17,10 June,Bassano del Grappa to Milan,315.0 km,Road stage"""

        edition = giro.giro1934()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "17 stages"

    def test_giro1935(self):
        route="""1,18 May,Milan to Cremona,165.0 km,Road stage
        ...
        18,9 June,Turin to Milan,290.0 km,Road stage"""

        edition = giro.giro1935()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "18 stages including 2 split stages"

    def test_giro1936(self):
        route="""1,16 May,Milan to Turin,161.0 km,Road stage
        ...
        19,7 June,Salsomaggiore Terme to Milan,248.0 km,Road stage"""

        edition = giro.giro1936()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "19 stages including 2 split stages"

    def test_giro1937(self):
        route="""1,8 May,Milan to Turin,165.0 km,Road stage
        ...
        19b,30 May,Como to Milan,141.0 km,Road stage"""

        edition = giro.giro1937()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "19 stages including 4 split stages"

    def test_giro1938(self):
        route="""1,7 May,Milan to Turin,182.0 km,Road stage
        ...
        18b,29 May,Locarno (Switzerland) to Milan,180.0 km,Road stage"""

        edition = giro.giro1938()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "18 stages including 3 split stages"

    def test_giro1939(self):
        route="""1,28 April,Milan to Turin,180.0 km,Road stage
        ...
        17,18 May,Sondrio to Milan,168.0 km,Road stage"""

        edition = giro.giro1939()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "17 stages including 2 split stages"

    def test_giro1940(self):
        route="""1,17 May,Milan to Turin,180.0 km,Road stage
        ...
        20,9 June,Verona to Milan,180.0 km,Road stage"""

        edition = giro.giro1940()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages"

    def test_giro1946(self):
        route="""1,15 June,Milan to Turin,185.0 km,Road stage
        ...
        17,7 July,Mantua to Milan,176.0 km,Road stage"""

        edition = giro.giro1946()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "17 stages including 3 split stages"

    def test_giro1947(self):
        route="""1,24 May,Milan to Turin,190.0 km,Road stage
        ...
        19,15 June,Lugano (Switzerland) to Milan,278.0 km,Road stage"""

        edition = giro.giro1947()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "19 stages including 1 split stage"

    def test_giro1948(self):
        route="""1,15 May,Milan to Turin,190.0 km,Road stage
        ...
        19,6 June,Brescia to Milan,231.0 km,Road stage"""

        edition = giro.giro1948()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "19 stages"

    def test_giro1949(self):
        route="""1,21 May,Palermo to Catania,261.0 km,Road stage
        ...
        19,12 June,Turin to Milan,267.0 km,Road stage"""

        edition = giro.giro1949()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "19 stages"

    def test_giro1950(self):
        route="""1,24 May,Milan to Salsomaggiore Terme,225.0 km,Road stage
        ...
        ,3 June,Rest day
        10,4 June,Bolzano to Milan,294.0 km,Road stage
        11,5 June,Milan to Ferrara,251.0 km,Road stage
        ...
        edition = giro.giro1950()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "18 stages"

    def test_giro1951(self):
        route="""1,19 May,Milan to Turin,202.0 km,Road stage
        ...
        20,10 June,Saint Moritz (Switzerland) to Milan,172.0 km,Road stage"""

        edition = giro.giro1951()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages"

    def test_giro1952(self):
        route="""1,17 May,Milan to Bologna,217.0 km,Road stage
        ...
        20,8 June,Verbania to Milan,147.0 km,Road stage"""

        edition = giro.giro1952()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages"

    def test_giro1953(self):
        route="""1,12 May,Milan to Abano Terme,263.0 km,Road stage
        ...
        20,2 June,Bormio to Milan,220.0 km,Road stage"""

        edition = giro.giro1953()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages including 1 split stage"

    def test_giro1954(self):
        route="""1,21 May,Palermo,36.0 km,Team time trial
        ...
        22,13 June,Saint Moritz (Switzerland) to Milan,222.0 km,Road stage"""
    ...
    def test_giro1955(self):
        route="""1,14 May,Milan to Turin,163.0 km,Road stage
        ...
        21,5 June,San Pellegrino Terme to Milan,141.0 km,Road stage"""
    ...
    def test_giro1956(self):
        route="""1,19 May,Milan to Alessandria,210.0 km,Road stage
        ...
        20,10 June,San Pellegrino Terme to Milan,113.0 km,Road stage"""

        edition = giro.giro1956()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages including 2 split stages"

    def test_giro1957(self):
        route="""1,18 May,Milan to Verona,191.0 km,Road stage
        ...
        21,9 June,Abano Terme to Milan,257.0 km,Road stage"""

        edition = giro.giro1957()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "21 stages including 1 split stage"

    def test_giro1958(self):
        route="""1,18 May,Milan to Varese,178.0 km,Road stage
        ...
        20,8 June,Salo to Milan,177.0 km,Road stage"""

        edition = giro.giro1958()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages"

    def test_giro1959(self):
        route="""1,16 May,Milan to Salsomaggiore Terme,135.0 km,Road stage
    ...
    def test_giro1960(self):
        route="""1,19 May,Rome to Naples,212.0 km,Road stage
        ...
        13,31 May,Saint-Vincent to Milan,225.0 km,Road stage
        ,1 June,Rest day
        ...
        21,9 June,Bormio to Milan,225.0 km,Road stage"""
    ...
    def test_giro1961(self):
        route="""1,20 May,Turin,115.0 km,Road stage
        ...
        21,11 June,Bormio to Milan,214.0 km,Road stage"""
    ...
    def test_giro1962(self):
        route="""1,19 May,Milan to Tabiano Terme,185.0 km,Road stage
        ...
        21,9 June,Saint-Vincent to Milan,160.0 km,Road stage"""

        edition = giro.giro1962()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "21 stages"

    def test_giro1963(self):
        route="""1,19 May,Naples to Potenza,182.0 km,Road stage
        ...
        21,9 June,Brescia to Milan,136.0 km,Road stage"""

        edition = giro.giro1963()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "21 stages"

    def test_giro1964(self):
        route="""1,16 May,Bolzano to Riva del Garda,173.0 km,Road stage
        ...
        22,7 June,Biella to Milan,146.0 km,Road stage"""

        edition = giro.giro1964()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages"

    def test_giro1965(self):
        route="""1,15 May,San Marino (San Marino) to Perugia,198.0 km,Road stage
        ...
        ,28 May,Rest day
        14,29 May,Milan to Novi Ligure,100.0 km,Road stage
    ...
    def test_giro1966(self):
        route="""1,18 May,Monte Carlo (Monaco) to Diano Marina,149.0 km,Road stage
        ...
        edition = giro.giro1966()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages"

    def test_giro1967(self):
        route="""1,20 May,Treviglio to Alessandria,135.0 km,Road stage
        ...
        22b,11 June,Madonna del Ghisallo to Milan,68.0 km,Road stage"""

        edition = giro.giro1967()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages including 1 split stage"

    def test_giro1968(self):
        route="""P,20 May,Campione d'Italia,5.7 km,Individual time trial
        ...
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages + Prologue"

    def test_giro1969(self):
        route="""1,16 May,Garda to Brescia,142.0 km,Road stage
        ...
        23,8 June,Folgarida to Milan,257.0 km,Road stage"""

        edition = giro.giro1969()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "23 stages including 1 split stage"

    def test_giro1970(self):
        route="""1,18 May,San Pellegrino Terme to Biandronno,115.0 km,Road stage
        ...
        edition = giro.giro1970()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages"

    def test_giro1971(self):
        route="""P,20 May,Lecce to Brindisi,62.2 km,Team time trial
        ...
        20b,10 June,Lainate to Milan,20.0 km,Individual time trial"""

        edition = giro.giro1971()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages + Prologue including 1 split stage"

    def test_giro1972(self):
        route="""1,21 May,Venice to Ravenna,196.0 km,Road stage
        ...
        20,11 June,Arco to Milan,185.0 km,Road stage"""

        edition = giro.giro1972()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages including 3 split stages"

    def test_giro1973(self):
        route="""P,18 May,Verviers (Belgium),5.2 km,Two man team time trial
        ...
        ,23 May,Rest day
        5,24 May,Saint-Vincent to Milan,173.0 km,Road stage
        6,25 May,Milan to Iseo,144.0 km,Road stage
        ...
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages + Prologue"

    def test_giro1974(self):
        route="""1,16 May,Vatican City (Vatican City) to Formia,164.0 km,Road stage
        ...
        22,8 June,Bassano del Grappa to Milan,257.0 km,Road stage"""
    ...
    def test_giro1975(self):
        route="""1,17 May,Milan to Fiorano Modenese,177.0 km,Road stage
    ...
    def test_giro1976(self):
        route="""1a,21 May,Catania,64.0 km,Road stage
        ...
        22b,12 June,Milan,106.0 km,Road stage"""

        edition = giro.giro1976()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages including 2 split stages"

    def test_giro1977(self):
        route="""P,20 May,Bacoli to Monte di Procida,7.0 km,Individual time trial
        ...
        22,12 June,Milan,122.0 km,Road stage"""

        edition = giro.giro1977()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages + Prologue including 4 split stages"

    def test_giro1978(self):
        route="""P,7 May,Saint-Vincent,2.0 km,Individual time trial
        ...
        20,28 May,Inverigo to Milan,220.0 km,Road stage"""

        edition = giro.giro1978()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages + Prologue including 1 split stage"

    def test_giro1979(self):
        route="""P,17 May,Florence,2.0 km,Individual time trial
        ...
        19,6 June,Cesano Maderno to Milan,44.0 km,Individual time trial"""

        edition = giro.giro1979()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "19 stages + Prologue"

    def test_giro1980(self):
        route="""P,15 May,Genoa,7.0 km,Individual time trial
        ...
        22,7 June,Milan,114.0 km,Road stage"""
    ...
    def test_giro1981(self):
        route="""P,13 May,Trieste,6.6 km,Individual time trial
        ...
        16,31 May,Milan to Mantua,178.0 km,Road stage
        ...
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages + Prologue including 1 split stage"

    def test_giro1982(self):
        route="""P,13 May,Milan,16.0 km,Individual time trial
    ...
    def test_giro1983(self):
        route="""P,12 May,Brescia,8.0 km,Individual time trial
        ...
        16a,29 May,Orta San Giulio to Milan,110.0 km,Road stage
        16b,29 May,Milan to Bergamo,100.0 km,Road stage
        ...
        edition = giro.giro1983()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages + Prologue including 1 split stage"

    def test_giro1984(self):
        route="""P,17 May,Lucca,5.0 km,Individual time trial
        ...
        15,2 June,Certosa di Pavia to Milan,38.0 km,Individual time trial
        ,3 June,Rest day
    ...
    def test_giro1985(self):
        route="""P,16 May,Verona,6.6 km,Individual time trial
        1,17 May,Verona to Busto Arsizio,218.0 km,Road stage
        2,18 May,Busto Arsizio to Milan,38.0 km,Team time trial
        3,19 May,Milan to Pinzolo,190.0 km,Road stage
        ...
        edition = giro.giro1985()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages + Prologue including 1 split stage"

    def test_giro1986(self):
        ...
        edition = giro.giro1986()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages + Prologue"

    def test_giro1987(self):
        route="""P,21 May,San Remo,4.0 km,Individual time trial
    ...
    def test_giro1988(self):
        route="""1,23 May,Urbino,9.0 km,Individual time trial
    ...
    def test_giro1989(self):
        route="""1,21 May,Taormina to Catania,123.0 km,Road stage
    ...
    def test_giro1990(self):
        route="""P,18 May,Bari,13.0 km,Individual time trial
        ...
        19,6 June,Milan,90.0 km,Road stage"""

        edition = giro.giro1990()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "19 stages + Prologue including 1 split stage"

    def test_giro1991(self):
        route="""1,26 May,Olbia,193.0 km,Road stage
        ...
        21,16 June,Pavia to Milan,153.0 km,Road stage"""
    ...
    def test_giro1992(self):
        route="""1,24 May,Genoa,8.0 km,Individual time trial
        ...
        22,14 June,Vigevano to Milan,66.0 km,Individual time trial"""
    ...
    def test_giro1993(self):
        route="""1a,23 May,Porto Azzurro to Porteferraio,85.0 km,Road stage
        ...
        21,13 June,Biella to Milan,166.0 km,Road stage"""
    ...
    def test_giro1994(self):
        route="""1a,22 May,Bologna,86.0 km,Road stage
        ...
        22,12 June,Turin to Milan,198.0 km,Road stage"""

        edition = giro.giro1994()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages including 1 split stage"

    def test_giro1995(self):
        route="""1,13 May,Perugia to Terni,205.0 km,Road stage
        ...
        22,4 June,Luino to Milan,148.0 km,Road stage"""

        edition = giro.giro1995()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages"

    def test_giro1996(self):
        route="""1,18 May,Athens (Greece),170.0 km,Road stage
        ...
        22,9 June,Sondrio to Milan,176.0 km,Road stage"""
    ...
    def test_giro1997(self):
        route="""1,17 May,Venezia,128.0 km,Road stage
        ...
        22,8 June,Boario Terme to Milan,165.0 km,Road stage"""
    ...
    def test_giro1998(self):
        route="""P,16 May,Nice (France),8.0 km,Individual time trial
        ...
        22,7 June,Lugano (Switzerland) to Milan,173.0 km,Road stage"""
    ...
    def test_giro1999(self):
        route="""1,15 May,Agrigento to Modica,175.0 km,Road stage
        ...
        22,6 June,Darfo Boario Terme to Milan,170.0 km,Road stage"""
    ...
    def test_giro2000(self):
        route="""P,13 May,Rome,4.6 km,Individual time trial
        ...
        21,4 June,Turin to Milan,189.0 km,Road stage"""

        edition = giro.giro2000()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "21 stages + Prologue"

    def test_giro2001(self):
        route="""P,19 May,Montesilvano to Pescara,7.0 km,Individual time trial
        ...
        21,10 June,Arona to Milan,125.0 km,Road stage"""

        edition = giro.giro2001()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "21 stages + Prologue"

    def test_giro2002(self):
        route="""P,11 May,Groningen (Netherlands),6.5 km,Individual time trial
        ...
        20,2 June,Cantu to Milan,141.0 km,Road stage"""

        edition = giro.giro2002()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages + Prologue"

    def test_giro2003(self):
        route="""1,10 May,Lecce,201.0 km,Road stage
        ...
        21,1 June,Milan,33.0 km,Individual time trial"""
    ...
    def test_giro2004(self):
        route="""P,8 May,Genoa,6.9 km,Individual time trial
        ...
        20,30 May,Clusone to Milan,149.0 km,Road stage"""
    ...
    def test_giro2005(self):
        route="""P,7 May,Reggio Calabria,1.1 km,Individual time trial
        ...
        20,29 May,Albese con Cassano to Milan,119.0 km,Road stage"""
    ...
    def test_giro2006(self):
        route="""1,6 May,Seraing (Belgium),6.2 km,Individual time trial
        ...
        21,28 May,Museo del Ghisallo to Milan,140.0 km,Road stage"""
    ...
    def test_giro2007(self):
        route="""1,12 May,Caprera to La Maddalena,25.6 km,Team time trial
        ...
        21,3 June,Vestone to Milan,185.0 km,Road stage"""
    ...
    def test_giro2008(self):
        route="""1,10 May,Palermo,23.6 km,Team time trial
        ...
        21,1 June,Milan,28.5 km,Individual time trial"""
    ...
    def test_giro2009(self):
        route="""1,9 May,Lido (Venice),20.5 km,Team time trial
        ...
        9,17 May,Milan,165.0 km,Road stage
        ,18 May,Rest day
    ...
    def test_giro2010(self):
        route="""1,8 May,Amsterdam (Netherlands),8.4 km,Individual time trial
    ...
    def test_giro2011(self):
        route="""1,7 May,Veneria Reale to Turin,19.3 km,Team time trial
        ...
        21,29 May,Milan,26.0 km,Individual time trial"""
    ...
    def test_giro2012(self):
        route="""1,5 May,Herning (Denmark),8.7 km,Individual time trial
        ...
        21,27 May,Milan,28.2 km,Individual time trial"""
    ...
    def test_giro2013(self):
        route="""1,4 May,Naples,130.0 km,Road stage
    ...
    def test_giro2014(self):
        route="""1,9 May,Belfast (Northern Ireland),21.7 km,Team time trial
    ...
    def test_giro2015(self):
        route="""1,9 May,San Lorenzo al Mare to San Remo,17.6 km,Team time trial
        ...
        21,31 May,Turin to Milan,185.0 km,Road stage"""
    ...
    def test_giro2016(self):
        route="""1,6 May,Apeldoorn (Netherlands),9.8 km,Individual time trial
    ...
    def test_giro2017(self):
        route="""1,5 May,Alghero to Olbia,206.0 km,Road stage
        ...
        21,28 May,Monza to Milan,29.3 km,Individual time trial"""
    ...
    def test_giro2018(self):
        route="""1,4 May,Jerusalem (Israel),9.7 km,Individual time trial
    ...
    def test_giro2019(self):
        route="""1,11 May,Bologna to San Luca,8.0 km,Individual time trial
