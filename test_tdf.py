...
class TestTourDeFrance:
    ...
    def test_tdf1903(self):
        route = """1,1 July,Paris to Lyon,467.0 km,Road stage
        ...
        assert edition.stage_summary == "6 stages"

    def test_tdf1904(self):
        route = """1,2 July,Montgeron to Lyon,467.0 km,Road stage
    ...
    def test_tdf1905(self):
        route = """1,9 July,Paris to Nancy,340.0 km,Road stage
        ...
        edition = tdf.tdf1905()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "11 stages"

    def test_tdf1906(self):
        route = """1,4 July,Paris to Lille,275.0 km,Road stage
    ...
    def test_tdf1907(self):
        route = """1,8 July,Paris to Roubaix,272.0 km,Road stage
    ...
    def test_tdf1908(self):
        route = """1,13 July,Paris to Roubaix,272.0 km,Road stage
    ...
    def test_tdf1909(self):
        route = """1,5 July,Paris to Roubaix,272.0 km,Road stage
    ...
    def test_tdf1910(self):
        route = """1,3 July,Paris to Roubaix,269.0 km,Road stage
    ...
    def test_tdf1911(self):
        route="""1,2 July,Paris to Dunkerque,351.0 km,Road stage
    ...
    def test_tdf1912(self):
        route="""1,30 June,Paris to Dunkerque,351.0 km,Road stage
    ...
    def test_tdf1913(self):
        route="""1,29 June,Paris to Le Havre,388.0 km,Road stage
    ...
    def test_tdf1914(self):
        route="""1,28 June,Paris to Le Havre,388.0 km,Road stage
    ...
    def test_tdf1920(self):
        route="""1,27 June,Paris to Le Havre,388.0 km,Road stage
    ...
    def test_tdf1921(self):
        route="""1,26 June,Paris to Le Havre,388.0 km,Road stage
    ...
    def test_tdf1922(self):
        route="""1,25 June,Paris to Le Havre,388.0 km,Road stage
    ...
    def test_tdf1923(self):
        route="""1,24 June,Paris to Le Havre,381.0 km,Road stage
    ...
    def test_tdf1924(self):
        route="""1,22 June,Paris to Le Havre,381.0 km,Road stage
    ...
    def test_tdf1925(self):
        route="""1,21 June,Paris to Le Havre,340.0 km,Road stage
    ...
    def test_tdf1926(self):
        route="""1,20 June,Evian to Mulhouse,373.0 km,Road stage
    ...
    def test_tdf1927(self):
        route="""1,19 June,Paris to Dieppe,180.0 km,Team time trial
    ...
    def test_tdf1928(self):
        route="""1,17 June,Paris to Caen,207.0 km,Team time trial
    ...
    def test_tdf1929(self):
        route="""1,30 June,Paris to Caen,206.0 km,Road stage
    ...
    def test_tdf1930(self):
        route="""1,2 July,Paris to Caen,206.0 km,Road stage
    ...
    def test_tdf1931(self):
        route="""1,30 June,Paris to Caen,208.0 km,Road stage
    ...
    def test_tdf1932(self):
        route="""1,6 July,Paris to Caen,208.0 km,Road stage
    ...
    def test_tdf1933(self):
        route="""1,27 June,Paris to Lille,262.0 km,Road stage
    ...
    def test_tdf1934(self):
        route = """1,3 July,Paris to Lille,262.0 km,Road stage
    ...
    def test_tdf1935(self):
        route="""1,4 July,Paris to Lille,262.0 km,Road stage
        ...
        edition = tdf.tdf1935()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "21 stages including 6 split stages"

    def test_tdf1936(self):
        route="""1,7 July,Paris to Lille,258.0 km,Road stage
        2,8 July,Lille to Charleville,192.0 km,Road stage
        3,9 July,Charleville to Metz,161.0 km,Road stage
        4,10 July,Metz to Belfort,220.0 km,Road stage
        5,11 July,Belfort to Evian-les-Bains,298.0 km,Road stage
        ,12 July,Rest day,Evian-les-Bains
        6,13 July,Evian-les-Bains to Aix-les-Bains,212.0 km,Road stage
        7,14 July,Aix-les-Bains to Grenoble,230.0 km,Road stage
        8,15 July,Grenoble to Briançon,194.0 km,Road stage
        9,16 July,Briançon to Digne,220.0 km,Road stage
        ,17 July,Rest day,Digne
        10,18 July,Digne to Nice,156.0 km,Road stage
        11,19 July,Nice to Cannes,126.0 km,Road stage
        ,20 July,Rest day,Cannes
        12,21 July,Cannes to Marseille,195.0 km,Road stage
        13a,22 July,Marseille to Nîmes,112.0 km,Road stage
        13b,22 July,Nîmes to Montpellier,52.0 km,Individual time trial
        14a,23 July,Montpellier to Narbonne,103.0 km,Road stage
        14b,23 July,Narbonne to Perpignan,63.0 km,Individual time trial
        ,24 July,Rest day,Perpignan
        15,25 July,Perpignan to Luchon,325.0 km,Road stage
        ,26 July,Rest day,Luchon
        16,27 July,Luchon to Pau,194.0 km,Road stage
        ,28 July,Rest day,Pau
        17,29 July,Pau to Bordeaux,229.0 km,Road stage
        18a,30 July,Bordeaux to Saintes,117.0 km,Road stage
        18b,30 July,Saintes to La Rochelle,75.0 km,Individual time trial
        19a,31 July,La Rochelle to La Roche-sur-Yon,81.0 km,Road stage
        19b,31 July,La Roche-sur-Yon to Cholet,65.0 km,Individual time trial
        19c,31 July,Cholet to Angers,67.0 km,Road stage
        20a,1 August,Angers to Vire,204.0 km,Road stage
        20b,1 August,Vire to Caen,55.0 km,Individual time trial
        21,2 August,Caen to Paris,234.0 km,Road stage"""

        edition = tdf.tdf1936()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "21 stages including 5 split stages"

    def test_tdf1937(self):
        route="""1,30 June,Paris to Lille,263.0 km,Road stage
        ...
        edition = tdf.tdf1937()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages including 8 split stages"

    def test_tdf1938(self):
        route="""1,5 July,Paris to Caen,215.0 km,Road stage
        2,6 July,Caen to Saint-Brieuc,237.0 km,Road stage
        3,7 July,Saint-Brieuc to Nantes,238.0 km,Road stage
        4a,8 July,Nantes to La Roche-sur-Yon,62.0 km,Road stage
        4b,8 July,La Roche-sur-Yon to La Rochelle,83.0 km,Road stage
        4c,8 July,La Rochelle to Royan,83.0 km,Road stage
        ,9 July,Rest day,Royan
        5,10 July,Royan to Bordeaux,198.0 km,Road stage
        6a,11 July,Bordeaux to Arcachon,53.0 km,Road stage
        6b,11 July,Arcachon to Bayonne,171.0 km,Road stage
        7,12 July,Bayonne to Pau,115.0 km,Road stage
        ,13 July,Rest day,Pau
        8,14 July,Pau to Luchon,193.0 km,Road stage
        ,15 July,Rest day,Luchon
        9,16 July,Luchon to Perpignan,260.0 km,Road stage
        10a,17 July,Perpignan to Narbonne,63.0 km,Road stage
        10b,17 July,Narbonne to Beziers,27.0 km,Individual time trial
        10c,17 July,Beziers to Montpellier,73.0 km,Road stage
        11,18 July,Montpellier to Marseille,223.0 km,Road stage
        12,19 July,Marseille to Cannes,199.0 km,Road stage
        ,20 July,Rest day,Cannes
        13,21 July,Cannes to Digne,284.0 km,Road stage
        14,22 July,Digne to Briançon,219.0 km,Road stage
        15,23 July,Briançon to Aix-les-Bains,311.0 km,Road stage
        ,24 July,Rest day,Aix-les-Bains
        16,25 July,Aix-les-Bains to Besançon,284.0 km,Road stage
        17a,26 July,Besançon to Belfort,89.0 km,Road stage
        17b,26 July,Belfort to Strasbourg,143.0 km,Road stage
        18,27 July,Strasbourg to Metz,186.0 km,Road stage
        19,28 July,Metz to Reims,196.0 km,Road stage
        ,29 July,Rest day,Reims
        20a,30 July,Reims to Laon,48.0 km,Road stage
        20b,30 July,Laon to Saint-Quentin,42.0 km,Individual time trial
        20c,30 July,Saint-Quentin to Lille,107.0 km,Road stage
        21,31 July,Lille to Paris,279.0 km,Road stage"""

        edition = tdf.tdf1938()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "21 stages including 5 split stages"

    def test_tdf1939(self):
        route="""1,10 July,Paris to Caen,215.0 km,Road stage
        ...
        edition = tdf.tdf1939()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "18 stages including 8 split stages"

    def test_tdf1947(self):
        route="""1,25 June,Paris to Lille,236.0 km,Road stage
    ...
    def test_tdf1948(self):
        route="""1,30 June,Paris to Trouville,237.0 km,Road stage
    ...
    def test_tdf1949(self):
        route="""1,30 June,Paris to Reims,182.0 km,Road stage
    ...
    def test_tdf1950(self):
        route="""1,13 July,Paris to Metz,307.0 km,Road stage
    ...
    def test_tdf1951(self):
        route="""1,4 July,Metz to Reims,185.0 km,Road stage
    ...
    def test_tdf1952(self):
        route="""1,25 June,Brest to Rennes,246.0 km,Road stage
    ...
    def test_tdf1954(self):
        ...
        edition = tdf.tdf1954()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "23 stages including 2 split stages"

    def test_tdf1955(self):
        route="""1a,7 July,Le Havre to Dieppe,102.0 km,Road stage
    ...
    def test_tdf1956(self):
        route="""1,5 July,Reims to Liège (Belgium),223.0 km,Road stage
    ...
    def test_tdf1957(self):
        route="""1,27 June,Nantes to Granville,204.0 km,Road stage
    ...
    def test_tdf1958(self):
        route="""1,26 June,Brussels (Belgium) to Ghent (Belgium),184.0 km,Road stage
    ...
    def test_tdf1961(self):
        route="""1a,25 June,Rouen to Versailles,136.5 km,Road stage
    ...
    def test_tdf1964(self):
        ...
        edition = tdf.tdf1964()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages including 3 split stages"

    def test_tdf1965(self):
        route="""1a,22 June,Cologne (West Germany) to Liège (Belgium),149.0 km,Road stage
    ...
    def test_tdf1966(self):
        route="""1,21 June,Nancy to Charleville,209.0 km,Road stage
    ...
    def test_tdf1967(self):
        route="""P,29 June,Angers,5.8 km,Individual time trial
        ...
        edition = tdf.tdf1967()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages + Prologue including 2 split stages"

    def test_tdf1968(self):
        route="""P,27 June,Vittel,6.1 km,Individual time trial
        ...
        edition = tdf.tdf1968()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages + Prologue including 3 split stages"

    def test_tdf1969(self):
        route="""P,28 June,Roubaix,10.0 km,Individual time trial
        ...
        edition = tdf.tdf1969()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "21 stages + Prologue including 3 split stages"

    def test_tdf1970(self):
        route="""P,26 June,Limoges,7.4 km,Individual time trial
        ...
        edition = tdf.tdf1970()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "23 stages + Prologue including 5 split stages"

    def test_tdf1971(self):
        route="""P,26 June,Mulhouse,11.0 km,Individual time trial
        ...
        edition = tdf.tdf1971()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages + Prologue including 3 split stages"

    def test_tdf1972(self):
        route="""P,1 July,Angers,7.2 km,Individual time trial
        ...
        edition = tdf.tdf1972()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages + Prologue including 4 split stages"

    def test_tdf1973(self):
        route="""P,30 June,Scheveningen (Netherlands),7.1 km,Individual time trial
        ...
        edition = tdf.tdf1973()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "20 stages + Prologue including 6 split stages"

    def test_tdf1974(self):
        route="""P,27 June,Brest,7.0 km,Individual time trial
    ...
    def test_tdf1975(self):
        route="""P,26 June,Charleroi (Belgium),6.0 km,Individual time trial
    ...
    def test_tdf1976(self):
        route="""P,24 June,Saint-Jean-de-Monts,8.0 km,Individual time trial
    ...
    def test_tdf1977(self):
        route="""P,30 June,Fleurance,5.0 km,Individual time trial
        ...
        edition = tdf.tdf1977()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "22 stages + Prologue including 5 split stages"

    def test_tdf1978(self):
        route="""P,29 June,Leiden (Netherlands),5.0 km,Individual time trial
    ...
    def test_tdf1979(self):
        route = """P,27 June,Fleurance,5.0 km,Individual time trial
        ...
        assert edition.stage_summary == "24 stages + Prologue"

    def test_tdf1980(self):
        route="""P,26 June,Frankfurt (West Germany),8.0 km,Individual time trial
    ...
    def test_tdf1981(self):
        route="""P,25 June,Nice,6.0 km,Individual time trial
    ...
    def test_tdf1982(self):
        route="""P,2 July,Basel (Switzerland),7.0 km,Individual time trial
        ...
        edition = tdf.tdf1982()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "21 stages + Prologue including 1 split stage"

    def test_tdf1983(self):
        route="""P,1 July,Fontenay-sous-Bois,6.0 km,Individual time trial
    ...
    def test_tdf1984(self):
        route="""P,29 June,Montreuil to Noisy-le-Sec,5.0 km,Individual time trial
    ...
    def test_tdf1985(self):
        route="""P,28 June,Plumelec,6.0 km,Individual time trial
    ...
    def test_tdf1986(self):
        route="""P,4 July,Boulogne-Billancourt,4.6 km,Individual time trial
        ...
        edition = tdf.tdf1986()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "23 stages + Prologue"

    def test_tdf1987(self):
        route="""P,1 July,West Berlin (West Germany),6.0 km,Individual time trial
        ...
        edition = tdf.tdf1987()
        assert edition.route == inspect.cleandoc(route)
        assert edition.stage_summary == "25 stages + Prologue"

    def test_tdf1988(self):
        route="""P,3 July,Pornichet to La Baule,1.0 km,Individual time trial
    ...
    def test_tdf1989(self):
        route="""P,1 July,Luxembourg City (Luxembourg),7.8 km,Individual time trial
    ...
    def test_tdf1990(self):
        route="""P,30 June,Futuroscope,6.3 km,Individual time trial
    ...
    def test_tdf1991(self):
        route="""P,6 July,Lyon,5.4 km,Individual time trial
    ...
    def test_tdf1992(self):
        route="""P,4 July,San Sebastián (Spain),8.0 km,Individual time trial
    ...
    def test_tdf1993(self):
        route="""P,3 July,Le Puy du Fou,6.8 km,Individual time trial
    ...
    def test_tdf1994(self):
        route="""P,2 July,Lille,7.2 km,Individual time trial
    ...
    def test_tdf1995(self):
        route="""P,1 July,Saint-Brieuc,7.3 km,Individual time trial
    ...
    def test_tdf1996(self):
        route="""P,29 June,'s-Hertogenbosch (Netherlands),9.4 km,Individual time trial
    ...
    def test_tdf1997(self):
        route="""P,5 July,Rouen,7.3 km,Individual time trial
    ...
    def test_tdf1998(self):
        route="""P,11 July,Dublin (Ireland),5.6 km,Individual time trial
    ...
    def test_tdf2000(self):
        route="""1,1 July,Futuroscope,16.5 km,Individual time trial
    ...
    def test_tdf2001(self):
        route="""P,7 July,Dunkerque,8.2 km,Individual time trial
    ...
    def test_tdf2002(self):
        route="""P,6 July,Luxembourg City (Luxembourg),7.0 km,Individual time trial
    ...
    def test_tdf2003(self):
        route="""P,5 July,Paris,6.5 km,Individual time trial
    ...
    def test_tdf2004(self):
        route="""P,3 July,Liège (Belgium),6.1 km,Individual time trial
    ...
    def test_tdf2005(self):
        route="""1,2 July,Fromentine to Noirmoutier-en-l'Île,19.0 km,Individual time trial
    ...
    def test_tdf2006(self):
        route="""P,1 July,Strasbourg,7.1 km,Individual time trial
    ...
    def test_tdf2007(self):
        route="""P,7 July,London (United Kingdom),7.9 km,Individual time trial
    ...
    def test_tdf2008(self):
        route="""1,5 July,Brest to Plumelec,197.5 km,Road stage
    ...
    def test_tdf2009(self):
        route="""1,4 July,Monaco (Monaco),15.5 km,Individual time trial
    ...
    def test_tdf2010(self):
        route="""P,3 July,Rotterdam (Netherlands),8.9 km,Individual time trial
    ...
    def test_tdf2011(self):
        route="""1,2 July,Passage du Gois to Mont des Alouettes,191.5 km,Road stage
    ...
    def test_tdf2012(self):
        route="""1,30 June,Liège (Belgium),6.4 km,Road stage
    ...
    def test_tdf2013(self):
        route="""1,29 June,Porto-Vecchio to Bastia,213.0 km,Road stage
    ...
    def test_tdf2014(self):
        route="""1,5 July,Leeds (United Kingdom) to Harrogate (United Kingdom),190.5 km,Road stage
    ...
    def test_tdf2015(self):
        route="""1,4 July,Utrecht (Netherlands),13.8 km,Individual time trial
    ...
    def test_tdf2016(self):
        route="""1,2 July,Mont Saint-Michel to Utah Beach (Sainte-Marie-du-Mont),188.0 km,Road stage
    ...
    def test_tdf2017(self):
        route="""1,1 July,Dusseldorf (Germany),14.0 km,Individual time trial
    ...
    def test_tdf2018(self):
        route = """1,7 July,Noirmoutier-en-l'Île to Fontenay-le-Comte,201.0 km,Road stage
